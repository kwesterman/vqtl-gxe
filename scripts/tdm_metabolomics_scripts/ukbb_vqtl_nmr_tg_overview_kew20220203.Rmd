...
# input files
dd.file <- "../data/raw/Data_Dictionary_Showcase_downloaded_20210908.csv"
res.dir <- "../data/processed/vignettes/tg_anthro/"
phe.file <- "../data/processed/vqtl_phenos_EUR.csv"
exp.file <- "../data/processed/ewis/ewis_phenos_EUR.csv"
var_info.file <- "../data/processed/vignettes/tg_anthro/variable_info"
pc.file <- "../data/processed/ewis/ewis_phenos_EUR_PCA_wbiomarkers"
whr.file <- "../data/processed/vignettes/tg_anthro/EUR_sexstrat_WHRadjBMI_INT.txt"
nmr.file <- "/humgen/florezlab/UKBB_app27892/ukb48298.tab.gz"
tg_snps.file <- "../data/processed/ewis/tg_anthro_vignette_variants.txt"
pvar.file <- "../data/processed/ewis/ewis_genotypes.pvar"
pgen.file <- "../data/processed/ewis/ewis_genotypes.pgen"
psam.file <- "../data/processed/ewis/ewis_genotypes.psam"
bmi_ss.file <- "../data/processed/ewis/tg_log/21001_EUR"

# output files
res.file <- "../data/processed/vignettes_tg_anthro/ukbb_vqtl_tg_gxe_lmresults_20220203.csv"
